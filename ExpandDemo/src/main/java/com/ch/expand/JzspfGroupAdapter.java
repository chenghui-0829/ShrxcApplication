...
public class JzspfGroupAdapter extends BaseExpandableListAdapter {
    ...
    public JzspfGroupAdapter(Context context, ArrayList<ParentEntity> parents) {
    ...
    public View getChildView(final int groupPosition, final int childPosition,
        ...
        final JzspfChildAdapter childAdapter = new JzspfChildAdapter(this.mContext,
                childs);
...
//        });
    ...
    public ExpandableListView getExpandableListView() {
        MyExpandableListView mExpandableListView = new MyExpandableListView(
                mContext);
        LayoutParams lp = new LayoutParams(
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(
                    R.layout.jz_elv_group_layout, null);
